...
sns_plot.figure.savefig('C:\\Users\\Aymane\\Documents\\Power markets\\Books\\Weron - Modeling and Forecasting Electricity Loads and Prices\\Chap4\\Implementation\\models\\C4-elasticNet\\c_occ50.png')
#####################################
#####################################
